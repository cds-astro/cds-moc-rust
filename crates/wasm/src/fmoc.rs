...
impl FMOC {
  ...
  pub fn from_ascii(data: &str) -> Result<FMOC, JsValue> {
  ...
  pub fn from_json(data: &str) -> Result<FMOC, JsValue> {
  ...
  pub fn from_fits(data: &[u8]) -> Result<FMOC, JsValue> {
  ...
  #[wasm_bindgen(catch)]
  pub fn not(&self) -> Result<FMOC, JsValue> {
    IsOneDimMOC::not(self)
  }
  #[wasm_bindgen(catch)]
  pub fn complement(&self) -> Result<FMOC, JsValue> {
    IsOneDimMOC::complement(self)
  }
  #[wasm_bindgen(catch)]
  pub fn degrade(&self, new_depth: u8) -> Result<FMOC, JsValue> {
    IsOneDimMOC::degrade(self, new_depth)
  }
  #[wasm_bindgen(catch)]
  pub fn or(&self, rhs: &FMOC) -> Result<FMOC, JsValue> {
    IsOneDimMOC::or(self, rhs)
  }
  #[wasm_bindgen(catch)]
  pub fn union(&self, rhs: &FMOC) -> Result<FMOC, JsValue> {
    IsOneDimMOC::union(self, rhs)
  }
  #[wasm_bindgen(catch)]
  pub fn and(&self, rhs: &FMOC) -> Result<FMOC, JsValue> {
    IsOneDimMOC::and(self, rhs)
  }
  #[wasm_bindgen(catch)]
  pub fn intersection(&self, rhs: &FMOC) -> Result<FMOC, JsValue> {
    IsOneDimMOC::intersection(self, rhs)
  }
  #[wasm_bindgen(catch)]
  pub fn xor(&self, rhs: &FMOC) -> Result<FMOC, JsValue> {
    IsOneDimMOC::xor(self, rhs)
  }
  #[wasm_bindgen(catch)]
  pub fn symmetric_difference(&self, rhs: &FMOC) -> Result<FMOC, JsValue> {
    IsOneDimMOC::symmetric_difference(self, rhs)
  }
  #[wasm_bindgen(catch)]
  pub fn minus(&self, rhs: &FMOC) -> Result<FMOC, JsValue> {
    IsOneDimMOC::minus(self, rhs)
  }
  #[wasm_bindgen(catch)]
  pub fn difference(&self, rhs: &FMOC) -> Result<FMOC, JsValue> {
