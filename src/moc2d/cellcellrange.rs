...
use crate::moc::{
  ...
  CellOrCellRangeMOCIntoIterator, NonOverlapping, ZSorted,
};
use crate::moc2d::{
  CellOrCellRangeMOC2ElemIt, CellOrCellRangeMOC2IntoIterator, CellOrCellRangeMOC2Iterator,
  ...
  R: MocQty<U>,
{
  ...
  fn cellcellrange_mocs_it(self) -> (Self::It1, Self::It2) {
    (
      self.moc_l.into_cellcellrange_moc_iter(),
      self.moc_r.into_cellcellrange_moc_iter(),
    )
  }
}
impl<'a, T, Q, U, R> CellOrCellRangeMOC2ElemIt<T, Q, U, R>
  for &'a CellOrCellRangeMOC2Elem<T, Q, U, R>
where
  T: Idx,
  Q: MocQty<T>,
  U: Idx,
...
impl<T, Q, U, R>
  CellOrCellRangeMOC2Iterator<
    T,
    Q,
    CellOrCellRangeMocIter<T, Q>,
    U,
    R,
    CellOrCellRangeMocIter<U, R>,
...
impl<'a, T, Q, U, R>
  CellOrCellRangeMOC2Iterator<
    T,
    Q,
    CellOrCellRangeRefMocIter<'a, T, Q>,
    U,
    R,
    CellOrCellRangeRefMocIter<'a, U, R>,
