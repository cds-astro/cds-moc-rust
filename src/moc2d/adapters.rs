...
use crate::moc::{
  adapters::{
    CellMOCIteratorFromRanges, CellOrCellRangeMOCIteratorFromCells,
...
use crate::moc2d::{
  CellMOC2ElemIt, CellMOC2IntoIterator, CellMOC2Iterator, CellOrCellRangeMOC2ElemIt,
  CellOrCellRangeMOC2IntoIterator, CellOrCellRangeMOC2Iterator, HasTwoMaxDepth, MOC2Properties,
...
impl<T, Q, U, R, E> CellMOC2ElemIt<T, Q, U, R> for RangeMOC2ElemItToCellMOC2ElemIt<T, Q, U, R, E>
where
  T: Idx,
  Q: MocQty<T>,
  U: Idx,
...
impl<T, Q, I, U, R, J, K, L>
  CellMOC2Iterator<
    T,
    Q,
    CellMOCIteratorFromRanges<T, Q, <K as RangeMOC2ElemIt<T, Q, U, R>>::It1>,
    U,
    R,
    CellMOCIteratorFromRanges<U, R, <K as RangeMOC2ElemIt<T, Q, U, R>>::It2>,
...
where
  ...
  E: RangeMOC2ElemIt<T, Q, U, R>,
{
  type It1 = CellOrCellRangeMOCIteratorFromCells<
    T,
    Q,
    CellMOCIteratorFromRanges<T, Q, <E as RangeMOC2ElemIt<T, Q, U, R>>::It1>,
  >;
  type It2 = CellOrCellRangeMOCIteratorFromCells<
    U,
    R,
  ...
  L: RangeMOC2Iterator<T, Q, I, U, R, J, K>,
{
  ...
  fn next(&mut self) -> Option<Self::Item> {
    self.0.next().map(|e| {
      RangeMOC2ElemItToCellCellRangeMOC2ElemIt(
        e,
        PhantomData,
        PhantomData,
        PhantomData,
...
{
  type It1 =
    RangeMOCIteratorFromCellOrCellRanges<T, Q, <E as CellOrCellRangeMOC2ElemIt<T, Q, U, R>>::It1>;
  type It2 =
    RangeMOCIteratorFromCellOrCellRanges<U, R, <E as CellOrCellRangeMOC2ElemIt<T, Q, U, R>>::It2>;
  ...
  L: CellOrCellRangeMOC2Iterator<T, Q, I, U, R, J, K>,
{
  ...
  fn next(&mut self) -> Option<Self::Item> {
    self.0.next().map(|e| {
      CellCellRangeMOC2ElemItToRangeMOC2ElemIt(
        e,
        PhantomData,
        PhantomData,
        PhantomData,
...
impl<T, Q, I, U, R, J, K, L>
  RangeMOC2Iterator<
    T,
    Q,
    RangeMOCIteratorFromCellOrCellRanges<T, Q, <K as CellOrCellRangeMOC2ElemIt<T, Q, U, R>>::It1>,
    U,
    R,
    RangeMOCIteratorFromCellOrCellRanges<U, R, <K as CellOrCellRangeMOC2ElemIt<T, Q, U, R>>::It2>,
...
impl<T, Q, U, R, E> RangeMOC2ElemIt<T, Q, U, R> for CellMOC2ElemItToRangeMOC2ElemIt<T, Q, U, R, E>
where
  T: Idx,
  Q: MocQty<T>,
  U: Idx,
...
impl<T, Q, I, U, R, J, K, L>
  RangeMOC2Iterator<
    T,
    Q,
    RangeMOCIteratorFromCells<T, Q, <K as CellMOC2ElemIt<T, Q, U, R>>::It1>,
    U,
    R,
    RangeMOCIteratorFromCells<U, R, <K as CellMOC2ElemIt<T, Q, U, R>>::It2>,
