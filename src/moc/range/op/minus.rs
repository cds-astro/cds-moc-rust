...
pub fn minus<T, Q, I1, I2>(left_it: I1, right_it: I2) -> MinusRangeIter<T, Q, I1, I2>
where
  T: Idx,
  Q: MocQty<T>,
  ...
  fn test_minus() {
    ...
    assert_eq!(
      (&minus_2)
        ...
        .len(),
      minus_2.moc_ranges().0 .0.len()
    );
    assert_eq!(
      minus_1.moc_ranges().0 .0.len(),
      minus_2.moc_ranges().0 .0.len()
    );
  }
}
