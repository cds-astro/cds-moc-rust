...
pub fn or<T, Q, I1, I2>(left_it: I1, right_it: I2) -> OrRangeIter<T, Q, I1, I2>
where
  T: Idx,
  Q: MocQty<T>,
  ...
  I2: RangeMOCIterator<T, Qty = Q>,
{
  depth: u8,
  last: Option<Range<T>>,
  strategy: Strategy<T, Q, I1, I2>, /*left_it: I1,
                                    right_it: I2,
                                    left: Option<Range<T>>,
        ...
        return OrRangeIter {
          ...
          strategy: Strategy::DisjointRightFirst {
            it: right
              .into_iter()
              .chain(right_it)
              .chain(left.into_iter().chain(left_it)),
          },
        };
      }
    }
        ...
        return OrRangeIter {
          ...
          strategy: Strategy::DisjointLeftFirst {
            it: left
              .into_iter()
              .chain(left_it)
              .chain(right.into_iter().chain(right_it)),
          },
        };
      }
    }
